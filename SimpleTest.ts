...
// import { make_value_set } from "./DataTypes/ValueSet";
// // import { v_div, v_mul } from "./ValueSetArith";

// const p_multiply =  primitive_propagator((...inputs: any[]) => {
//     // console.log("multiple inputs", inputs);
//     const result = inputs.reduce((acc, curr) => v_mul(acc, curr), make_value_set([]));
...
//     return inputs.slice(1).reduce((acc, curr) => v_div(acc, curr), inputs[0]);
// }, "subdivide"); 
