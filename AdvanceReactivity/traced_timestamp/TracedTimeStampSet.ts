...
export function construct_traced_timestamp_set(timestamps: traced_timestamp[]): BetterSet<traced_timestamp> {
...
define_generic_procedure_handler(_timestamp_layer_equal, all_match(is_timestamp_set), (a: BetterSet<traced_timestamp>, b: BetterSet<traced_timestamp>) => {
    var eq = true 
