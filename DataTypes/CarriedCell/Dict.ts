 ...
 * Cache is disabled: every call creates a new accessor. merge_carried_map bi_syncs them;
 * callers must run execute_all_tasks_sequential before reading from a fresh accessor so bi_sync
 * propagates. See: lain-lang/docs/CE_DICT_ACCESSOR_CACHE.md
 */
